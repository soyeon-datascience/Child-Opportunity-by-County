...
ggplot(df2, aes(x = df2$county_code, y = df2$count, fill = df2$Factor))+
  ...
  theme_bw()+
  labs(title = "Los Angeles Index of good residential environment by county", subtitle = "Livability = Green Space Access + Near Supermarket + Walkability", y = "Index of good residential environment", x = "County", fill = 'Factor')+
